...
int main(int argc, char *argv[]){
   ...
   // string query_str; 
    ...
    cout << *lista.begin();
    cout << endl;
    cout << "Numero de enfermedades que contienen la palanra \"cancer\": "<<lista.size();
	...
	// Prueba de lower bound;

	clinvar::iterator iterador = conjuntoMutaciones.lower_bound("17",43078938);
